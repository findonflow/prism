export const cadenceMutatePublishToParent = `
...
transaction(parent: Address, factoryAddress: Address, filterAddress: Address){
  prepare(signer: auth(Storage, Capabilities) &Account) {
    ...
    /*--------------------------------------------------------------------------------------------------------------------*/
    // Clean up previously existing capabilities
    /*--------------------------------------------------------------------------------------------------------------------*/
    let oldPath = PublicPath(identifier: HybridCustody.getCapabilityDelegatorIdentifier(parent))
    signer.capabilities.unpublish(oldPath!)
